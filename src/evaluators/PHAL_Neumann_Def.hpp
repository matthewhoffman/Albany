...
//        << it->first << std::endl;
  ...
  // else parse the input to determine what type of BC to calculate
    ...
    // is there a "(" in the string?
      ...
      physicalParametersList = p.get<Teuchos::ParameterList*>("FELIX Physical Parameters");
      useGLP = physicalParametersList->get<bool>("Use GLP", true); // Default to GLP on unless actively disabled
